		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#compresalescentraltranslationform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compresalescentraltranslationform-display": {
								"semanticObject": "compresalescentraltranslationform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.presalescentral.translationform",
									"url": sap.ui.require.toUrl("com/presalescentral/translationform")
								}
							}
						}
					}
